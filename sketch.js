...
function setup() {
  ...
  bubble = createSprite(690,460,20,20);
  ...
  blink.frameDelay = 20;
  eat.frameDelay = 20;
  bunny = createSprite(670,100,100,100);
  bunny.addImage(rabbit);
  bunny.scale = 0.2;
  higherground =new Ground(700,170,100,10);
  ...
  rope = new Rope(4,{x:600,y:360});
  rope2 = new Rope(4,{x:450,y:470});
...
{
  background(51);
  image(bg_img,3,-10,width,height);
...
fill('#FFF717');
  drawSprites();
text("feed the HUNGRY bunny!! :)",500,750);
}
